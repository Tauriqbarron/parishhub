				...
				{#if registrationUrl && !urlNotConfigured}
					...
					<div>
						...
						<div class="flex items-center gap-3">
							<div class="flex-1 bg-gray-50 rounded-md px-3 py-2 text-sm text-gray-700 border border-gray-200 truncate">
								{registrationUrl}
							</div>
							<button
								type="button"
						...
						<div class="flex flex-col sm:flex-row items-start gap-6">
							...
							<div class="space-y-3">
								<p class="text-sm text-gray-600">
									Scan this QR code to access the public registration form.
									Print and display at your parish for easy access.
								</p>
								<button
									type="button"
						...
						<div class="flex">
							...
							<div class="ml-3">
								<p class="text-sm text-yellow-700">
									No base URL configured. Enter your publicly accessible URL above and click Save to generate a QR code.
								</p>
							</div>
						</div>
					</div>
