...
<div>
	<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
		<div>
			<h1 class="text-2xl font-bold text-gray-900">Households</h1>
			<p class="text-gray-600 mt-1">Manage parish households and their members</p>
		</div>
		<button
	...
	<div class="bg-white shadow rounded-lg overflow-hidden">
		...
		{:else if $householdsStore.error}
			...
			<div class="p-6 text-center">
				...
				<h3 class="mt-2 text-sm font-medium text-gray-900">Error loading households</h3>
				<p class="mt-1 text-sm text-gray-500">{$householdsStore.error}</p>
				<div class="mt-6">
					<button
		...
		{:else if $householdsStore.households.length === 0}
			...
			<div class="p-6 text-center">
				...
				<h3 class="mt-2 text-sm font-medium text-gray-900">No households found</h3>
