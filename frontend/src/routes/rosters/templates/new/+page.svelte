...
<div class="page">
	...
	<section>
		...
		<label
			>Name <input
				type="text"
				bind:value={name}
				placeholder="e.g. Sunday 9am Mass"
				maxlength={200}
			/></label
		>
		<label
			>Description <textarea bind:value={description} placeholder="Optional" rows={2}
			></textarea></label
		>
	</section>
		...
		{#each slots as slot}
			<div class="slot-row">
				...
				<input
					...
					placeholder="Label (e.g. 1st Reading)"
				/>
				<input
					type="number"
	...
	<div class="form-footer">
		...
		<button class="btn-primary" onclick={handleSave} disabled={saving}
			>{saving ? 'Creating…' : 'Create Template'}</button
		>
	</div>
</div>
