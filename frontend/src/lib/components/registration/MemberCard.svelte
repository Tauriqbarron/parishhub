...
<div class="border border-brand-border rounded-lg bg-white shadow-sm">
	<button
		type="button"
		class="w-full px-4 py-3 flex items-center justify-between text-left hover:bg-brand-bg-subtle focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-inset rounded-t-lg"
	...
	>
		<div class="flex items-center gap-2">
			...
			{#if member.isHeadOfHousehold}
				<span
					class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-brand-accent/10 text-brand-primary"
				>
					Head of Household
				</span>
			{/if}
			...
			<div class="flex items-center justify-between pt-2">
				{#if member.familyRole !== 'child'}
					<label class="flex items-center gap-2 cursor-pointer">
						...
						/>
						<span class="text-sm text-brand-text-secondary">Head of Household</span>
				...
				{:else}
					<label class="flex items-center gap-2 cursor-pointer">
						<input
							...
							class="rounded border-brand-border text-brand-accent focus:ring-brand-accent"
						/>
						<span class="text-sm text-brand-text-secondary">Lives in household</span>
				...
				{#if showDeleteConfirm}
					<div class="flex items-center gap-2">
						...
						<button
							...
							class="px-3 py-1 text-sm font-medium text-white bg-brand-error text-white rounded hover:bg-brand-error/90 focus:outline-none focus:ring-2 focus:ring-brand-error"
						>
							Yes, Remove
						</button>
						<button
				...
				{:else}
					<button
						...
						class="text-sm text-brand-error hover:text-brand-error/80 focus:outline-none focus:underline"
					>
						Remove Member
					</button>
				{/if}
